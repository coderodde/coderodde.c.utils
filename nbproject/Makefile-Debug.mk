...
# C Compiler Flags
CFLAGS=-O3 -ansi -pedantic -Wno-int-to-void-pointer-cast -Wno-int-conversion -std=c11
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/crtreemap
...
${OBJECTDIR}/stable_sort.o: stable_sort.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stable_sort.o stable_sort.c
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/crtreemap
